...
def get_image(image_url='https://www.autocar.co.uk/sites/autocar.co.uk/files/styles/body-image/public/ferrari_f8_tributo.jpg?itok=1TG8_Tnx', size=(128, 128)):
...
for i,ii in enumerate(reconstructed_images):
	imageio.imwrite(save_path+'image_{}.jpg'.format(i), ii)
